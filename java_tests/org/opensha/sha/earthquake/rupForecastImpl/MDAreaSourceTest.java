...
public class MDAreaSourceTest {
	...
	public void Test_pointRupture_NumRup(){
		System.out.println("TEST 1 : Test_pointRupture_NumRup");
	...
	public void Test_pointRupture_FMD(){
		System.out.println("TEST 2 : Test_pointRupture_FMD");
		// 
	...
	public void Test_finiteRupture_FMD_depthDist(){
		//
		System.out.println("TEST 3 : Test_finiteRupture_FMD_depthDist");
		// 
		double[] magVec03;
		double[] focMechWei;
		double[] depVec03;
