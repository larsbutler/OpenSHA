...
public class AS_1996_test implements ParameterChangeWarningListener {
	...
	/**
	 * Check AS_1996 usage for computing hazard curves using GEM1ERF constructed
	...
	public final void GEM1ERFPointRuptures() throws Exception{
		AS1996AttenRel.setIntensityMeasure(RelativeSignificantDuration_Param.NAME);
		...
		hazCurveCalculator.getHazardCurve(hazCurve, site, AS1996AttenRel,
				erf);
	}
