...
*/
private static final String MEDIAN_M5_M8_R1_30_100_SS_D_TABLE = "staffordetal2009_M5-M8_R1-30-100_SS_D.out";
																 
/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. SS and D
*/
private static final String MEDIAN_M55_M65_M75_R01_250_SS_D_TABLE = "staffordetal2009_M55-M65-M75_R01-250_SS_D.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. SS and C.
*/
private static final String MEDIAN_M5_M8_R1_30_100_SS_C_TABLE = "staffordetal2009_M5-M8_R1-30-100_SS_C.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. SS and C
*/
private static final String MEDIAN_M55_M65_M75_R01_250_SS_C_TABLE = "staffordetal2009_M55-M65-M75_R01-250_SS_C.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. SS and B.
*/
private static final String MEDIAN_M5_M8_R1_30_100_SS_B_TABLE = "staffordetal2009_M5-M8_R1-30-100_SS_B.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. SS and B.
*/
private static final String MEDIAN_M55_M65_M75_R01_250_SS_B_TABLE = "staffordetal2009_M55-M65-M75_R01-250_SS_B.out";
...
*/
private static final String MEDIAN_M5_M8_R1_30_100_R_D_TABLE = "staffordetal2009_M5-M8_R1-30-100_R_D.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. R and D
*/
private static final String MEDIAN_M55_M65_M75_R01_250_R_D_TABLE = "staffordetal2009_M55-M65-M75_R01-250_R_D.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. R and C.
*/
private static final String MEDIAN_M5_M8_R1_30_100_R_C_TABLE = "staffordetal2009_M5-M8_R1-30-100_R_C.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. R and C
*/
private static final String MEDIAN_M55_M65_M75_R01_250_R_C_TABLE = "staffordetal2009_M55-M65-M75_R01-250_R_C.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. R and B.
*/
private static final String MEDIAN_M5_M8_R1_30_100_R_B_TABLE = "staffordetal2009_M5-M8_R1-30-100_R_B.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. R and B.
*/
private static final String MEDIAN_M55_M65_M75_R01_250_R_B_TABLE = "staffordetal2009_M55-M65-M75_R01-250_R_B.out";
...
*/
private static final String MEDIAN_M5_M8_R1_30_100_N_D_TABLE = "staffordetal2009_M5-M8_R1-30-100_N_D.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. N and D
*/
private static final String MEDIAN_M55_M65_M75_R01_250_N_D_TABLE = "staffordetal2009_M55-M65-M75_R01-250_N_D.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. N and C.
*/
private static final String MEDIAN_M5_M8_R1_30_100_N_C_TABLE = "staffordetal2009_M5-M8_R1-30-100_N_C.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. N and C
*/
private static final String MEDIAN_M55_M65_M75_R01_250_N_C_TABLE = "staffordetal2009_M55-M65-M75_R01-250_N_C.out";

/**
* Table for median ground motion validation. M5 to M8 at R=1,30 and 100km. N and B.
*/
private static final String MEDIAN_M5_M8_R1_30_100_N_B_TABLE = "staffordetal2009_M5-M8_R1-30-100_N_B.out";

/**
* Table for median ground motion validation. M5.5, M6.5 and M7.5 at R=1 to 250km. N and B.
*/
private static final String MEDIAN_M55_M65_M75_R01_250_N_B_TABLE = "staffordetal2009_M55-M65-M75_R01-250_N_B.out";
...
validateMedian_1(vs30, rake, focaldepth, medianTable_SS_D_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_SS_D_2);
}
...
double rake = 0.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_SS_C_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_SS_C_2);
}
...
double rake = 0.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_SS_B_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_SS_B_2);
}
...
double rake = 90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_R_D_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_R_D_2);
}
...
double rake = 90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_R_C_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_R_C_2);
}
...
double rake = 90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_R_B_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_R_B_2);
}
...
double rake = -90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_N_D_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_N_D_2);
}
...
double rake = -90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_N_C_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_N_C_2);
}
...
double rake = -90.0;
double focaldepth = 10.0;
validateMedian_1(vs30, rake, focaldepth, medianTable_N_B_1);
validateMedian_2(vs30, rake, focaldepth, medianTable_N_B_2);
}


/**
* Check Setal_2009 usage for computing hazard curves using GEM1ERF constructed
...
Setal2009AttenRel.setIntensityMeasure(IA_Param.NAME);
...
hazCurveCalculator.getHazardCurve(hazCurve, site, Setal2009AttenRel,
erf);
}
...
private void validateMedian_1(double vs30, double rake, double focaldepth, double[][] table) {
// check for IA
for (int j = 0; j < table.length; j++) {
double mag = 5+j*0.01;
System.out.println(mag);
double expectedMedian_R1 = table[j][0];
System.out.println(expectedMedian_R1);

double computedMedian_R1 = Math.exp(Setal2009AttenRel.getMean(mag,1.0, vs30, rake, focaldepth));
...
private void validateMedian_2(double vs30, double rake, double focaldepth, double[][] table) {
	// check for IA
	for (int j = 0; j < table.length; j++) {
	double rrup = 0.1+j*0.1;
	double expectedMedian_M55 = table[j][0];
	double computedMedian_M55 = Math.exp(Setal2009AttenRel.getMean(5.5,rrup, vs30, rake, focaldepth));
...
double computedStd = Setal2009AttenRel.getStdDev(i - 1,
stdDevType) / Setal2009Constants.LOG10_2_LN;
...
double computedStd = Setal2009AttenRel.getStdDev(1, stdDevType)
/ Setal2009Constants.LOG10_2_LN;
assertEquals(expectedStd, computedStd, TOLERANCE);
}
// check for PGV
for (int j = 0; j < table.length; j++) {
double expectedStd = table[j][columnDescr.length - 1];
double computedStd = Setal2009AttenRel.getStdDev(0, stdDevType)
/ Setal2009Constants.LOG10_2_LN;
assertEquals(expectedStd, computedStd, TOLERANCE);
}
} 
