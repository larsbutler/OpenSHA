...
import org.opensha.sha.imr.attenRelImpl.CL_2002_AttenRel;

public class CL_2002_test {

    private CL_2002_AttenRel chandler_Lam2002_stable_continental =
            null;
    private Configuration config = null;
    // the current dir is something like "bin", parent is something like
    // "opengem" which contains this:
    private final String testDataDir = "/test_data/";
